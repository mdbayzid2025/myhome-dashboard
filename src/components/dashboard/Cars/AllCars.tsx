          ...
          <Table>
            <TableHeader className="bg-muted/40">
              <TableRow>
                ...
                <TableHead className="w-28">Seat Number</TableHead>
            ...
            <TableBody>
              {isLoading ? (
                ...
                <TableRow key={car._id} data-aos="fade-up" data-aos-delay={index * 100} className="hover:bg-muted/30 border-b last:border-0">
                  ...
                  <TableCell className="pl-5! font-medium">{car?.seatNumber}</TableCell>
                    ...
                    <div className="w-32">
                      {car?.host === '—' ? (
                        ...
                        <div className="flex items-center gap-3  rounded-md">
                          ...
                          {car?.assignedHosts?.profileImage &&
                            <img
                ...
                <TableCell colSpan={8}>
                  <p className="text-lg text-center py-10">Car data not found.</p>
                </TableCell>
              </TableRow>}
            </TableBody>
          </Table>
