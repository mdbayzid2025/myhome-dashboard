                            ...
                            <div className="border rounded-xl overflow-hidden divide-y">
                                <div className="p-4 flex justify-between items-center">
                                    ...
                                    <span className="font-medium">
                                        RM {bookingData?.rentalPrice?.toLocaleString() ?? '0'}
                                    </span>
                                </div>
                                <div className="p-4 flex justify-between items-center text-blue-700 bg-blue-50/60">
                                    <span>Deposite</span>
                                    <span>RM {bookingData?.car?.depositAmount?.toLocaleString() ?? '0'}</span>
                                </div>
                                <div className="p-4 flex justify-between items-center text-red-700 bg-red-50/60">
                                    <span>Platform Fee</span>
                                    <span>RM {bookingData?.platformFee?.toLocaleString() ?? '0'}</span>
                                </div>
                                <div className="p-4 flex justify-between items-center text-yellow-700 bg-yellow-50/60"> 
                                    <span>Admin Commission</span>
                                    <span>RM {bookingData?.adminCommission?.toLocaleString() ?? '0'}</span>
                                </div>
